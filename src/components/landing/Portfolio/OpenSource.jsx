...
function PortfolioCard({ title, pageUrl, sourceUrl }, i) {
  ...
  const images = useStaticQuery(graphql`
    query {
      UrlShortener: file(relativePath: { eq: "portfolio/under-construction.jpg" }, absolutePath: {}) {
        childImageSharp {
          fluid(fit: COVER) {
      ...
      EQuizz: file(relativePath: { eq: "portfolio/under-construction.jpg" }, absolutePath: {}) {
        childImageSharp {
          fluid(fit: COVER) {
            ...GatsbyImageSharpFluid
          }
      ...
      GrepVoodh: file(relativePath: { eq: "portfolio/under-construction.jpg" }, absolutePath: {}) {
        childImageSharp {
          fluid(fit: COVER) {
            ...GatsbyImageSharpFluid
          }
